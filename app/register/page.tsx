      ...
      <div className="w-full max-w-md bg-white border border-[#E4E4E7] rounded-xl p-8 shadow-sm">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-[#71717A] mt-1 font-light">
            Register to generate your celestial blueprint report
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <Label htmlFor="name" className="text-xs font-semibold text-zinc-700 uppercase tracking-wider">
              Full Name
            </Label>
          ...
          <div className="space-y-1.5">
            <Label htmlFor="confirmPassword" className="text-xs font-semibold text-zinc-700 uppercase tracking-wider">
              Confirm Password
            </Label>
            <div className="relative">
              <Lock className="absolute left-3 top-3 h-4 w-4 text-zinc-400" />
        ...
        <div className="relative my-5">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-white px-3 text-zinc-400 font-light">Or register with</span>
          </div>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-[#71717A] font-light">
          ...
          <Link href="/login" className="text-[#3B0A45] hover:underline font-medium transition-colors">
            Log in here
          </Link>
        </p>
      </div>
